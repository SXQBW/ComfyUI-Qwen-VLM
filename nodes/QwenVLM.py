...
# Define the directory for saving Qwen-VL files
QwenVLM = Path(folder_paths.folder_names_and_paths["QWEN"][0][0]) / "QwenVLM"
QwenVLM.mkdir(parents=True, exist_ok=True)

# Model VRAM requirements (approximate, in GB)
MODEL_VRAM_REQUIREMENTS = {
    "Qwen2.5-VL-3B-Instruct": 6,
    "Qwen2.5-VL-3B-Instruct-AWQ": 4,
    "Qwen2.5-VL-7B-Instruct": 14,
    "Qwen2.5-VL-7B-Instruct-AWQ": 6,
    "Qwen2.5-VL-32B-Instruct": 70,
    "Qwen2.5-VL-32B-Instruct-AWQ": 22,
    "Qwen2.5-VL-72B-Instruct": 152,
    "Qwen2.5-VL-72B-Instruct-AWQ": 46,
    "Qwen2-VL-2B": 4,
    "Qwen2-VL-2B-Instruct": 4,
    "Qwen2-VL-7B": 14,
    "Qwen2-VL-72B": 40,
    "Qwen2-VL-2B-AWQ": 2,
...
QWEN2_VL_MODELS = {
    ...
    "Qwen2.5-VL-32B-Instruct-AWQ": "Qwen/Qwen2.5-VL-32B-Instruct-AWQ",
    "Qwen2.5-VL-72B-Instruct": "Qwen/Qwen2.5-VL-72B-Instruct",
    "Qwen2.5-VL-72B-Instruct-AWQ": "Qwen/Qwen2.5-VL-72B-Instruct-AWQ",
...
class Qwen2VLPredictor:
    ...
    def generate_predictions(self, image_path, prompt, max_new_tokens=512, temperature=0.7, top_p=0.9, video_frames=None, fps=1.0):
        try:
            ...
            generated_tokens = output_ids[:, input_length:]  # 截取新生成的token
            
            # 解码输出
            generated_text = self.tokenizer.decode(
                generated_tokens[0],  # 使用正确的变量
...
class QwenVisionParser:
    ...
    def generate(self, image, text_input, model_name, memory_mode="Balanced (8-bit)", 
        ...
        temp_path = QwenVLM / "temp_image.png"
        ...
        if video_frames is not None:
            ...
            for frame in video_frames[1:]:
                frame_path = QwenVLM / f"temp_frame_{len(video_frame_list)}.png"
